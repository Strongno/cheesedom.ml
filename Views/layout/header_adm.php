...
<html lang="en">
    <head>
        ...
        <link href="/template/adminpanel/css/style.default.css" rel="stylesheet">

        <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
        <!--[if lt IE 9]>
        <script src="/template/adminpanel/js/html5shiv.js"></script>
        <script src="/template/adminpanel/js/respond.min.js"></script>
        <![endif]-->
    </head>
            ...
            <div class="headerwrapper">
                <div class="header-left">
                    <a href="index.html" class="logo">
                        <img src="/template/adminpanel/template/adminpanel/images/logo.png" alt="" /> 
                    </a>
                        ...
                        <div class="btn-group btn-group-list btn-group-notification">
                            ...
                            <div class="dropdown-menu pull-right">
                                ...
                                <ul class="media-list dropdown-list">
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="/template/adminpanel//template/adminpanel/images/photos/user1.png" alt="">
                                    ...
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="/template/adminpanel//template/adminpanel/images/photos/user2.png" alt="">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="/template/adminpanel//template/adminpanel/images/photos/user3.png" alt="">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="/template/adminpanel/images/photos/user4.png" alt="">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="/template/adminpanel/images/photos/user1.png" alt="">
                                        <div class="media-body">
                        ...
                        <div class="btn-group btn-group-list btn-group-messages">
                            ...
                            <div class="dropdown-menu pull-right">
                                ...
                                <ul class="media-list dropdown-list">
                                    ...
                                    <li class="media">
                                        <span class="badge badge-success">New</span>
                                        <img class="img-circle pull-left noti-thumb" src="/template/adminpanel/images/photos/user2.png" alt="">
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <img class="img-circle pull-left noti-thumb" src="/template/adminpanel/images/photos/user3.png" alt="">
                                        <div class="media-body">
                ...
                <div class="leftpanel">
                    <div class="media profile-left">
                        <a class="pull-left profile-thumb" href="profile.html">
                            <img class="img-circle" src="/template/adminpanel/images/photos/profile.png" alt="">
                        </a>
                        <div class="media-body">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li><a href="/admin/order"><i class="fa fa-home"></i> <span>Страница заказов</span></a></li>
                        <li><a href="/admin/category"><i class="fa fa-home"></i> <span>Категории продуктов</span></a></li>
                        <li><a href="/admin/product"><i class="fa fa-home"></i> <span>Продукты</span></a></li>
