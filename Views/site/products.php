					...
					<article class="post-entry plastic" style="border:1px solid #cbcbcb;">
						...
						<? endif; ?>	
							...
							<div style="float:left;margin-left:150px;">
								<a href="/cart/add/<?php echo $productItem['id']; ?>" style='line-height:30px;margin-left:20%;color:white;position:relative' >
								<input type='submit' style='position:absolute;height:35px;line-height: 15px;' value='В корзину'></a>
							</div>
							</form>
						</div>
					</article>
